...
function Highlights({stats}) {
  return (
    <div className="bg-slate-600 p-2 text-slate-200 flex flex-col justify-start items-center hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer">
